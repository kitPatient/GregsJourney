...
recipes.addShaped(<botania:specialflower>, [[<botania:petal:12>, <minecraft:coal>, <botania:petal:12>],[<botania:livingwood:1>, <minecraft:red_flower:*>, <botania:livingwood:1>], [<botania:livingwood:1>, <botania:livingwood:1>, <botania:livingwood:1>]]);
recipes.addShaped(<contenttweaker:material_part:11> * 2, [[<gregtech:meta_dust:324>, <contenttweaker:material_part:6>, null],[null, null, null], [null, null, null]]);
//File End
